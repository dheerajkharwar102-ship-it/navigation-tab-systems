...
<script>
   ...
   // Function to collect curtain data for product_curtain_data
   ...
   // Function to collect curtain set data
   function collectCurtainSetData($container, productId, variantId, roomId) {
      ...
      $container.find('.accessory-tab').each(function() {
         ...
         if ($accessoryContent.length) {
            ...
            accessoryConfig.accessory_types.push($accessoryTab.find('.accessory-tab-name').text());

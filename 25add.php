                     ...
                     <div class="detail-group">
                        ...
                        <div class="accessory-selection-container">
                           <select class="form-control accessory-options-select">
                              <option value="">Select</option>
                              ${accessoryOptions.map(option => `
                                 <option value="${option.accessory_id}" data-price="${option.price}" data-accessory-type="${accessory.name}" data-price_type="${option.price_type}" data-price_depends_on="${option.price_depends_on}" data-image="${option.accessory_img}">${option.accessory_name}</option>
                              `).join('')}
                           </select>
                        </div>
                     </div>

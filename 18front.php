...
<script>
   ...
   function calculateProductTotal(productId, roomId, productType = null) {
      console.log('Calculating product total for:', { productId, roomId, productType });
   ...
   // Enhanced function to calculate curtain installation charge
   function calculateCurtainInstallationCharge($productContent, productId, roomId) {
      let installationCharge = 0;
      
      // Check if installation is needed
      const $installationCheckbox = $productContent.find('.curtain-installation-needed-checkbox');
      if ($installationCheckbox.length && $installationCheckbox.is(':checked')) {
         installationCharge = 200; // $200 charge for installation
         console.log('Installation charge applied: $200');
      }
   ...
   $(document).on('change', '.curtain-installation-needed-checkbox', function(){
      ...
      if ($productContent.length) {
         ...
         console.log('Installation checkbox changed, recalculating...');

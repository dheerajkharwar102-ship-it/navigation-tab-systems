...
<script>
    ...
    // Update the calculateMaterialCosts function in edit script
...
<script>
    ...
    // Update the replacement material change handler
...
<script>
    ...
    // Replace the existing createMaterialSection function in edit script
    ...
    // Update the createMaterialLabelContent function to handle existing data
    function createMaterialLabelContent(product, variant, category, label, categoryData, roomId, productInstanceId, variantId, existingData, index = 0) {
        ...
        if (materialsForLabel.length === 0 && allMaterials.length > 0) {
            // No specific materials for this label, show empty selection
            return createSingleMaterialInputForLabel(product, variant, category, label, null, allMaterials, roomId, variantId, existingMaterialData);
        }
        ...
        <div class="material-group" data-category="${category}" data-label="${label}">
            ...
            <div class="material-grid">
                ...
                <div class="material-inputs-compact-replacement">
                    <div class="material-compact-image-replacement">
                        ${existingReplacement && allMaterials.find(mat => mat.material_id == existingReplacement)?.material_img ? 
                            `<img src="<?= URL ?>/uploads/material/${allMaterials.find(mat => mat.material_id == existingReplacement)?.material_img}" alt="" style="width:100%;height:100%;object-fit:cover;">` : 
                            `<i class="fa fa-image"></i>`
                        }
                    </div>
                    <div class="material-compact-fields">
